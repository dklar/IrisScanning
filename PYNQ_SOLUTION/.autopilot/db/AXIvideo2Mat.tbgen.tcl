...
set C_modelArgList {
	{ AXI_video_strm_V_data_V int 32 regular {axi_s 0 volatile  { inputStream Data } }  }
	{ AXI_video_strm_V_keep_V int 4 regular {axi_s 0 volatile  { inputStream Keep } }  }
	{ AXI_video_strm_V_strb_V int 4 regular {axi_s 0 volatile  { inputStream Strb } }  }
	{ AXI_video_strm_V_user_V int 1 regular {axi_s 0 volatile  { inputStream User } }  }
	{ AXI_video_strm_V_last_V int 1 regular {axi_s 0 volatile  { inputStream Last } }  }
	{ AXI_video_strm_V_id_V int 1 regular {axi_s 0 volatile  { inputStream ID } }  }
	{ AXI_video_strm_V_dest_V int 1 regular {axi_s 0 volatile  { inputStream Dest } }  }
...
set portList { 
	...
	{ img_cols_V_out_din sc_out sc_lv 10 signal 13 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inputStream_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "inputStream_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "inputStream_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
 	{ "name": "inputStream_TKEEP", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "AXI_video_strm_V_keep_V", "role": "default" }} , 
 	{ "name": "inputStream_TSTRB", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "AXI_video_strm_V_strb_V", "role": "default" }} , 
 	{ "name": "inputStream_TUSER", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_user_V", "role": "default" }} , 
 	{ "name": "inputStream_TLAST", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_last_V", "role": "default" }} , 
 	{ "name": "inputStream_TID", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_id_V", "role": "default" }} , 
 	{ "name": "inputStream_TDEST", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "91003"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "91003"}
]}
...
set Spec2ImplPortList { 
	AXI_video_strm_V_data_V { axis {  { inputStream_TDATA in_data 0 32 }  { inputStream_TVALID in_vld 0 1 } } }
	AXI_video_strm_V_keep_V { axis {  { inputStream_TKEEP in_data 0 4 } } }
	AXI_video_strm_V_strb_V { axis {  { inputStream_TSTRB in_data 0 4 } } }
	AXI_video_strm_V_user_V { axis {  { inputStream_TUSER in_data 0 1 } } }
	AXI_video_strm_V_last_V { axis {  { inputStream_TLAST in_data 0 1 } } }
	AXI_video_strm_V_id_V { axis {  { inputStream_TID in_data 0 1 } } }
	AXI_video_strm_V_dest_V { axis {  { inputStream_TREADY in_acc 1 1 }  { inputStream_TDEST in_data 0 1 } } }
