...
set C_modelArgMapList {[ 
	{ "Name" : "fb", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "img_rows_V_out", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ img_rows_V_out_din sc_out sc_lv 8 signal 4 } 
	{ img_rows_V_out_full_n sc_in sc_logic 1 signal 4 } 
	{ img_rows_V_out_write sc_out sc_logic 1 signal 4 } 
	{ img_cols_V_out_din sc_out sc_lv 10 signal 5 } 
	{ img_cols_V_out_full_n sc_in sc_logic 1 signal 5 } 
	{ img_cols_V_out_write sc_out sc_logic 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fb_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "fb", "role": "address0" }} , 
 	...
 	{ "name": "img_rows_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "img_rows_V", "role": "dout" }} , 
 	...
 	{ "name": "img_rows_V_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "img_rows_V_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.top_level_mul_multde_U104", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "23233"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "23233"}
]}
...
set Spec2ImplPortList { 
	fb { ap_memory {  { fb_address0 mem_address 1 15 }  { fb_ce0 mem_ce 1 1 }  { fb_q0 mem_dout 0 8 } } }
	img_rows_V { ap_fifo {  { img_rows_V_dout fifo_data 0 8 }  { img_rows_V_empty_n fifo_status 0 1 }  { img_rows_V_read fifo_update 1 1 } } }
	...
	img_rows_V_out { ap_fifo {  { img_rows_V_out_din fifo_data 1 8 }  { img_rows_V_out_full_n fifo_status 0 1 }  { img_rows_V_out_write fifo_update 1 1 } } }
