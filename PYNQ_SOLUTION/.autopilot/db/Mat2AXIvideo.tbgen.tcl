...
set C_modelArgList {
	...
	{ AXI_video_strm_V_data_V int 32 regular {axi_s 1 volatile  { outputStream Data } }  }
	{ AXI_video_strm_V_keep_V int 4 regular {axi_s 1 volatile  { outputStream Keep } }  }
	{ AXI_video_strm_V_strb_V int 4 regular {axi_s 1 volatile  { outputStream Strb } }  }
	{ AXI_video_strm_V_user_V int 1 regular {axi_s 1 volatile  { outputStream User } }  }
	{ AXI_video_strm_V_last_V int 1 regular {axi_s 1 volatile  { outputStream Last } }  }
	{ AXI_video_strm_V_id_V int 1 regular {axi_s 1 volatile  { outputStream ID } }  }
	{ AXI_video_strm_V_dest_V int 1 regular {axi_s 1 volatile  { outputStream Dest } }  }
}
...
set portList { 
	...
	{ outputStream_TDATA sc_out sc_lv 32 signal 3 } 
	{ outputStream_TVALID sc_out sc_logic 1 outvld 9 } 
	{ outputStream_TREADY sc_in sc_logic 1 outacc 3 } 
	{ outputStream_TKEEP sc_out sc_lv 4 signal 4 } 
	{ outputStream_TSTRB sc_out sc_lv 4 signal 5 } 
	{ outputStream_TUSER sc_out sc_lv 1 signal 6 } 
	{ outputStream_TLAST sc_out sc_lv 1 signal 7 } 
	{ outputStream_TID sc_out sc_lv 1 signal 8 } 
	{ outputStream_TDEST sc_out sc_lv 1 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outputStream_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "outputStream_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
 	{ "name": "outputStream_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "outputStream_TKEEP", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "AXI_video_strm_V_keep_V", "role": "default" }} , 
 	{ "name": "outputStream_TSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "AXI_video_strm_V_strb_V", "role": "default" }} , 
 	{ "name": "outputStream_TUSER", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_user_V", "role": "default" }} , 
 	{ "name": "outputStream_TLAST", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_last_V", "role": "default" }} , 
 	{ "name": "outputStream_TID", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_id_V", "role": "default" }} , 
 	{ "name": "outputStream_TDEST", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "23233", "Max" : "23233"}
	, {"Name" : "Interval", "Min" : "23233", "Max" : "23233"}
]}
...
set Spec2ImplPortList { 
	...
	AXI_video_strm_V_data_V { axis {  { outputStream_TDATA out_data 1 32 }  { outputStream_TREADY out_acc 0 1 } } }
	AXI_video_strm_V_keep_V { axis {  { outputStream_TKEEP out_data 1 4 } } }
	AXI_video_strm_V_strb_V { axis {  { outputStream_TSTRB out_data 1 4 } } }
	AXI_video_strm_V_user_V { axis {  { outputStream_TUSER out_data 1 1 } } }
	AXI_video_strm_V_last_V { axis {  { outputStream_TLAST out_data 1 1 } } }
	AXI_video_strm_V_id_V { axis {  { outputStream_TID out_data 1 1 } } }
	AXI_video_strm_V_dest_V { axis {  { outputStream_TVALID out_vld 1 1 }  { outputStream_TDEST out_data 1 1 } } }
}
