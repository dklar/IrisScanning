...
set C_modelArgList {
	...
	{ fb int 8 regular {array 89600 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ fb_address0 sc_out sc_lv 17 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fb_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "fb", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "fb", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"}]}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "90441", "Max" : "90441"}
	, {"Name" : "Interval", "Min" : "90441", "Max" : "90441"}
]}
...
set Spec2ImplPortList { 
	...
	fb { ap_memory {  { fb_address0 mem_address 1 17 }  { fb_ce0 mem_ce 1 1 }  { fb_we0 mem_we 1 1 }  { fb_d0 mem_din 1 8 } } }
}
