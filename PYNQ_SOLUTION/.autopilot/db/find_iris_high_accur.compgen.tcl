...
set ID 47
set hasByteEnable 0
set MemName find_iris_high_aceOg
...
set ID 48
set hasByteEnable 0
set MemName find_iris_high_acfYi
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 37
...
eval "cg_default_interface_gen_dc { \
    id 52 \
    name dst_img_data_stream_V \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_dst_img_data_stream_V \
    op interface \
    ports { dst_img_data_stream_V_din { O 8 vector } dst_img_data_stream_V_full_n { I 1 bit } dst_img_data_stream_V_write { O 1 bit } } \
} "
}
