...
set portList { 
	...
	{ r1_dout sc_in sc_lv 32 signal 2 } 
	{ r1_empty_n sc_in sc_logic 1 signal 2 } 
	{ r1_read sc_out sc_logic 1 signal 2 } 
	{ r2 sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "r1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "r1", "role": "dout" }} , 
 	{ "name": "r1_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "r1", "role": "empty_n" }} , 
 	{ "name": "r1_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "r1", "role": "read" }} , 
 	{ "name": "r2", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "r2", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "r1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "r1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "r2", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"}]}]}
...
set Spec2ImplPortList { 
	...
	r1 { ap_fifo {  { r1_dout fifo_data 0 32 }  { r1_empty_n fifo_status 0 1 }  { r1_read fifo_update 1 1 } } }
	r2 { ap_none {  { r2 in_data 0 32 } } }
}
