...
wire   [5:0] arctan_V268_address0;
reg    arctan_V268_ce0;
wire   [5:0] arctan_V268_q0;
wire   [53:0] man_V_2_fu_198_p3;
reg   [53:0] man_V_2_reg_606;
...
reg   [8:0] tmp_24_reg_642;
wire   [0:0] and_ln603_fu_344_p2;
reg   [0:0] and_ln603_reg_647;
wire    ap_CS_fsm_state3;
wire   [0:0] or_ln603_fu_350_p2;
reg   [0:0] or_ln603_reg_652;
wire   [7:0] select_ln603_1_fu_356_p3;
reg   [7:0] select_ln603_1_reg_657;
wire   [0:0] or_ln603_2_fu_369_p2;
reg   [0:0] or_ln603_2_reg_662;
wire   [7:0] select_ln603_3_fu_415_p3;
wire    ap_CS_fsm_state4;
wire   [3:0] n_fu_432_p2;
reg   [3:0] n_reg_675;
wire    ap_CS_fsm_state5;
wire   [0:0] icmp_ln99_fu_426_p2;
...
reg  signed [7:0] z_i_old_V_reg_97;
reg  signed [7:0] z_r_old_V_reg_109;
reg   [7:0] p_Val2_18_reg_121;
reg   [3:0] ush_reg_131;
wire   [63:0] zext_ln100_fu_438_p1;
...
wire   [53:0] p_Result_31_fu_188_p1;
wire   [0:0] p_Result_s_fu_154_p3;
wire   [53:0] man_V_1_fu_192_p2;
...
wire   [0:0] and_ln585_1_fu_327_p2;
wire   [0:0] and_ln585_fu_315_p2;
wire   [7:0] trunc_ln586_fu_286_p1;
wire   [0:0] and_ln582_fu_295_p2;
wire   [0:0] or_ln603_1_fu_363_p2;
wire   [31:0] bitcast_ln696_fu_378_p1;
wire   [0:0] tmp_25_fu_381_p3;
wire   [7:0] trunc_ln581_fu_375_p1;
wire   [7:0] shl_ln604_fu_397_p2;
wire   [7:0] select_ln588_fu_389_p3;
wire   [7:0] select_ln603_fu_402_p3;
wire   [7:0] select_ln603_2_fu_409_p3;
wire   [6:0] zext_ln99_fu_422_p1;
wire   [7:0] zext_ln100_1_fu_449_p1;
wire   [6:0] mul_ln1193_fu_482_p0;
wire   [13:0] zext_ln1118_fu_471_p1;
wire  signed [7:0] mul_ln1193_fu_482_p1;
wire   [13:0] lhs_V_fu_474_p3;
wire   [13:0] mul_ln1193_fu_482_p2;
wire   [6:0] mul_ln1192_fu_506_p0;
wire  signed [7:0] mul_ln1192_fu_506_p1;
wire   [13:0] mul_ln1192_fu_506_p2;
wire   [13:0] lhs_V_1_fu_498_p3;
wire   [0:0] tmp_26_fu_453_p3;
wire   [7:0] add_ln703_fu_518_p2;
wire   [7:0] sub_ln703_fu_461_p2;
wire   [13:0] ret_V_fu_488_p2;
wire   [13:0] ret_V_2_fu_524_p2;
wire   [7:0] tmp_7_fu_554_p4;
wire   [7:0] tmp_s_fu_544_p4;
wire   [13:0] ret_V_1_fu_512_p2;
wire   [13:0] ret_V_3_fu_530_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln99_fu_426_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        tmp_24_reg_642 <= {{sh_amt_fu_236_p3[11:3]}};
        trunc_ln583_reg_636 <= trunc_ln583_fu_250_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln99_fu_426_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if ((((icmp_ln99_fu_426_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state5)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        arctan_V268_ce0 = 1'b1;
    end else begin
        arctan_V268_ce0 = 1'b0;
    end
end
...
assign add_ln703_fu_518_p2 = (p_Val2_18_reg_121 + zext_ln100_1_fu_449_p1);
...
assign and_ln585_1_fu_327_p2 = (xor_ln585_fu_321_p2 & and_ln581_fu_310_p2);
...
assign arctan_V268_address0 = zext_ln100_fu_438_p1;

assign ashr_ln586_fu_281_p2 = $signed(man_V_2_reg_606) >>> zext_ln586_fu_277_p1;
...
assign icmp_ln603_fu_272_p2 = ((tmp_24_reg_642 == 9'd0) ? 1'b1 : 1'b0);

assign icmp_ln99_fu_426_p2 = ((ush_reg_131 == 4'd10) ? 1'b1 : 1'b0);

assign ireg_V_fu_146_p1 = grp_fu_142_p1;

assign lhs_V_1_fu_498_p3 = {{z_i_old_V_reg_97}, {6'd0}};

assign lhs_V_fu_474_p3 = {{z_r_old_V_reg_109}, {6'd0}};

assign lshr_ln1333_fu_443_p2 = 7'd64 >> zext_ln99_fu_422_p1;

assign man_V_1_fu_192_p2 = (54'd0 - p_Result_31_fu_188_p1);

assign man_V_2_fu_198_p3 = ((p_Result_s_fu_154_p3[0:0] === 1'b1) ? man_V_1_fu_192_p2 : p_Result_31_fu_188_p1);

assign mul_ln1192_fu_506_p0 = zext_ln1118_fu_471_p1;

assign mul_ln1192_fu_506_p1 = z_r_old_V_reg_109;

assign mul_ln1192_fu_506_p2 = ($signed({{1'b0}, {mul_ln1192_fu_506_p0}}) * $signed(mul_ln1192_fu_506_p1));

assign mul_ln1193_fu_482_p0 = zext_ln1118_fu_471_p1;

assign mul_ln1193_fu_482_p1 = z_i_old_V_reg_97;

assign mul_ln1193_fu_482_p2 = ($signed({{1'b0}, {mul_ln1193_fu_482_p0}}) * $signed(mul_ln1193_fu_482_p1));
...
assign or_ln603_1_fu_363_p2 = (and_ln585_fu_315_p2 | and_ln582_fu_295_p2);

assign or_ln603_2_fu_369_p2 = (or_ln603_fu_350_p2 | or_ln603_1_fu_363_p2);

assign or_ln603_fu_350_p2 = (and_ln603_fu_344_p2 | and_ln585_1_fu_327_p2);

assign p_Result_31_fu_188_p1 = tmp_fu_180_p3;

assign p_Result_s_fu_154_p3 = ireg_V_fu_146_p1[32'd63];

assign phi_V_fu_536_p3 = ((tmp_26_fu_453_p3[0:0] === 1'b1) ? add_ln703_fu_518_p2 : sub_ln703_fu_461_p2);

assign ret_V_1_fu_512_p2 = (mul_ln1192_fu_506_p2 + lhs_V_1_fu_498_p3);

assign ret_V_2_fu_524_p2 = (lhs_V_fu_474_p3 + mul_ln1193_fu_482_p2);

assign ret_V_3_fu_530_p2 = (lhs_V_1_fu_498_p3 - mul_ln1192_fu_506_p2);

assign ret_V_fu_488_p2 = (lhs_V_fu_474_p3 - mul_ln1193_fu_482_p2);

assign select_ln588_fu_389_p3 = ((tmp_25_fu_381_p3[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign select_ln603_1_fu_356_p3 = ((and_ln585_fu_315_p2[0:0] === 1'b1) ? trunc_ln586_fu_286_p1 : trunc_ln583_reg_636);

assign select_ln603_2_fu_409_p3 = ((or_ln603_reg_652[0:0] === 1'b1) ? select_ln603_fu_402_p3 : select_ln603_1_reg_657);

assign select_ln603_3_fu_415_p3 = ((or_ln603_2_reg_662[0:0] === 1'b1) ? select_ln603_2_fu_409_p3 : 8'd0);
...
assign sub_ln703_fu_461_p2 = (p_Val2_18_reg_121 - zext_ln100_1_fu_449_p1);

assign tmp_25_fu_381_p3 = bitcast_ln696_fu_378_p1[32'd31];

assign tmp_26_fu_453_p3 = p_Val2_18_reg_121[32'd7];

assign tmp_7_fu_554_p4 = {{ret_V_2_fu_524_p2[13:6]}};

assign tmp_8_fu_572_p4 = {{ret_V_1_fu_512_p2[13:6]}};

assign tmp_9_fu_582_p4 = {{ret_V_3_fu_530_p2[13:6]}};
...
assign trunc_ln583_fu_250_p1 = man_V_2_fu_198_p3[7:0];
...
assign z_i_V_fu_592_p3 = ((tmp_26_fu_453_p3[0:0] === 1'b1) ? tmp_9_fu_582_p4 : tmp_8_fu_572_p4);

assign z_r_V_fu_564_p3 = ((tmp_26_fu_453_p3[0:0] === 1'b1) ? tmp_7_fu_554_p4 : tmp_s_fu_544_p4);

assign zext_ln100_1_fu_449_p1 = arctan_V268_q0;

assign zext_ln100_fu_438_p1 = ush_reg_131;

assign zext_ln1118_fu_471_p1 = lshr_ln1333_reg_685;

assign zext_ln461_fu_172_p1 = exp_tmp_V_fu_162_p4;

assign zext_ln586_fu_277_p1 = $unsigned(sext_ln581_fu_264_p1);

assign zext_ln99_fu_422_p1 = ush_reg_131;
