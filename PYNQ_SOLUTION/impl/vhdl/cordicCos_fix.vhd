...
architecture behav of cordicCos_fix is 
    ...
    signal arctan_V233_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal arctan_V233_ce0 : STD_LOGIC;
    signal arctan_V233_q0 : STD_LOGIC_VECTOR (3 downto 0);
    signal man_V_14_fu_200_p3 : STD_LOGIC_VECTOR (53 downto 0);
    signal man_V_14_reg_626 : STD_LOGIC_VECTOR (53 downto 0);
    ...
    signal tmp_60_reg_662 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal select_ln603_10_fu_368_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln603_10_reg_677 : STD_LOGIC_VECTOR (7 downto 0);
    signal or_ln603_8_fu_381_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln603_8_reg_682 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln603_12_fu_427_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal z_r_old_V_reg_99 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_Val2_88_reg_111 : STD_LOGIC_VECTOR (7 downto 0);
    signal z_i_old_V_reg_121 : STD_LOGIC_VECTOR (7 downto 0);
    signal ush_reg_133 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln126_fu_450_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal p_Result_85_fu_190_p1 : STD_LOGIC_VECTOR (53 downto 0);
    signal p_Result_s_fu_156_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal man_V_13_fu_194_p2 : STD_LOGIC_VECTOR (53 downto 0);
    ...
    signal tmp_59_fu_220_p4 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal and_ln585_8_fu_339_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal or_ln603_7_fu_375_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln603_11_fu_421_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln125_fu_434_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal a_V_fu_461_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln728_fu_469_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal mul_ln1193_fu_502_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal sext_ln1118_5_fu_491_p1 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal mul_ln703_fu_526_p0 : STD_LOGIC_VECTOR (7 downto 0);
    signal mul_ln703_fu_526_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal mul_ln703_fu_526_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal lhs_V_5_fu_518_p3 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_62_fu_473_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ret_V_10_fu_544_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_15_fu_574_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_s_fu_564_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal ret_V_9_fu_532_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal ret_V_11_fu_550_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_17_fu_602_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_16_fu_592_p4 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    arctan_V233_U : component cordicCos_fix_arckbM
    generic map (
        DataWidth => 4,
        AddressRange => 50,
        AddressWidth => 6)
    ...
    top_level2_fpext_lbW_U59 : component top_level2_fpext_lbW
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((icmp_ln125_fu_438_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    p_Val2_88_reg_111_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    z_i_old_V_reg_121_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    z_r_old_V_reg_99_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                ...
                tmp_60_reg_662 <= sh_amt_fu_248_p3(11 downto 3);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln125_fu_438_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
                r_V_reg_705 <= r_V_fu_455_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state5, icmp_ln125_fu_438_p2)
    begin
        case ap_CS_fsm is
    ...
    a_V_fu_461_p3 <= (arctan_V233_q0 & ap_const_lv3_0);
    add_ln581_fu_236_p2 <= std_logic_vector(signed(ap_const_lv12_FF9) + signed(F2_fu_214_p2));
    add_ln703_fu_538_p2 <= std_logic_vector(unsigned(p_Val2_88_reg_111) + unsigned(zext_ln728_fu_469_p1));
    ...
    and_ln585_8_fu_339_p2 <= (xor_ln585_fu_333_p2 and and_ln581_fu_322_p2);
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state5, icmp_ln125_fu_438_p2)
    begin
        if ((((icmp_ln125_fu_438_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5)) or ((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state5, icmp_ln125_fu_438_p2)
    begin
        if (((icmp_ln125_fu_438_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state5, icmp_ln125_fu_438_p2, z_r_old_V_reg_99, ap_return_preg)
    begin
        if (((icmp_ln125_fu_438_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    arctan_V233_address0 <= zext_ln126_fu_450_p1(6 - 1 downto 0);

    arctan_V233_ce0_assign_proc : process(ap_CS_fsm_state5)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
    ...
    ashr_ln586_fu_293_p2 <= std_logic_vector(shift_right(signed(man_V_14_reg_626),to_integer(unsigned('0' & zext_ln586_fu_289_p1(31-1 downto 0)))));
    bitcast_ln696_fu_390_p1 <= x;
    exp_tmp_V_fu_164_p4 <= ireg_V_fu_148_p1(62 downto 52);
    icmp_ln125_fu_438_p2 <= "1" when (ush_reg_133 = ap_const_lv4_A) else "0";
    icmp_ln571_fu_208_p2 <= "1" when (trunc_ln556_fu_152_p1 = ap_const_lv63_0) else "0";
    icmp_ln581_fu_230_p2 <= "1" when (signed(tmp_59_fu_220_p4) > signed(ap_const_lv9_0)) else "0";
    ...
    icmp_ln603_fu_284_p2 <= "1" when (tmp_60_reg_662 = ap_const_lv9_0) else "0";
    ireg_V_fu_148_p1 <= grp_fu_144_p1;
    lhs_V_5_fu_518_p3 <= (z_i_old_V_reg_121 & ap_const_lv7_0);
    lhs_V_fu_494_p3 <= (z_r_old_V_reg_99 & ap_const_lv7_0);
    man_V_13_fu_194_p2 <= std_logic_vector(unsigned(ap_const_lv54_0) - unsigned(p_Result_85_fu_190_p1));
    man_V_14_fu_200_p3 <= 
        man_V_13_fu_194_p2 when (p_Result_s_fu_156_p3(0) = '1') else 
        p_Result_85_fu_190_p1;
    mul_ln1193_fu_502_p0 <= sext_ln1118_5_fu_491_p1(8 - 1 downto 0);
    mul_ln1193_fu_502_p1 <= z_i_old_V_reg_121;
    ...
    mul_ln703_fu_526_p0 <= z_r_old_V_reg_99;
    mul_ln703_fu_526_p1 <= sext_ln1118_5_fu_491_p1(8 - 1 downto 0);
    mul_ln703_fu_526_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(mul_ln703_fu_526_p0) * signed(mul_ln703_fu_526_p1))), 15));
    ...
    or_ln603_7_fu_375_p2 <= (and_ln585_fu_327_p2 or and_ln582_fu_307_p2);
    or_ln603_8_fu_381_p2 <= (or_ln603_fu_362_p2 or or_ln603_7_fu_375_p2);
    or_ln603_fu_362_p2 <= (and_ln603_fu_356_p2 or and_ln585_8_fu_339_p2);
    p_Result_85_fu_190_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_182_p3),54));
    p_Result_s_fu_156_p3 <= ireg_V_fu_148_p1(63 downto 63);
    phi_V_fu_556_p3 <= 
        add_ln703_fu_538_p2 when (tmp_62_fu_473_p3(0) = '1') else 
        sub_ln703_fu_481_p2;
    r_V_fu_455_p2 <= std_logic_vector(shift_right(signed(ap_const_lv8_80),to_integer(unsigned('0' & zext_ln125_fu_434_p1(8-1 downto 0)))));
    ret_V_10_fu_544_p2 <= std_logic_vector(unsigned(lhs_V_fu_494_p3) + unsigned(mul_ln1193_fu_502_p2));
    ret_V_11_fu_550_p2 <= std_logic_vector(unsigned(lhs_V_5_fu_518_p3) - unsigned(mul_ln703_fu_526_p2));
    ret_V_9_fu_532_p2 <= std_logic_vector(unsigned(mul_ln703_fu_526_p2) + unsigned(lhs_V_5_fu_518_p3));
    ret_V_fu_508_p2 <= std_logic_vector(unsigned(lhs_V_fu_494_p3) - unsigned(mul_ln1193_fu_502_p2));
    select_ln588_fu_401_p3 <= 
        ap_const_lv8_FF when (tmp_61_fu_393_p3(0) = '1') else 
        ap_const_lv8_0;
    select_ln603_10_fu_368_p3 <= 
        trunc_ln586_fu_298_p1 when (and_ln585_fu_327_p2(0) = '1') else 
        trunc_ln583_reg_656;
    select_ln603_11_fu_421_p3 <= 
        select_ln603_fu_414_p3 when (or_ln603_reg_672(0) = '1') else 
        select_ln603_10_reg_677;
    select_ln603_12_fu_427_p3 <= 
        select_ln603_11_fu_421_p3 when (or_ln603_8_reg_682(0) = '1') else 
        ap_const_lv8_0;
    select_ln603_fu_414_p3 <= 
        shl_ln604_fu_409_p2 when (and_ln603_reg_667(0) = '1') else 
        select_ln588_fu_401_p3;
        sext_ln1118_5_fu_491_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(r_V_reg_705),15));
    ...
    sub_ln703_fu_481_p2 <= std_logic_vector(unsigned(p_Val2_88_reg_111) - unsigned(zext_ln728_fu_469_p1));
    tmp_15_fu_574_p4 <= ret_V_10_fu_544_p2(14 downto 7);
    tmp_16_fu_592_p4 <= ret_V_9_fu_532_p2(14 downto 7);
    tmp_17_fu_602_p4 <= ret_V_11_fu_550_p2(14 downto 7);
    tmp_59_fu_220_p4 <= F2_fu_214_p2(11 downto 3);
    tmp_61_fu_393_p3 <= bitcast_ln696_fu_390_p1(31 downto 31);
    tmp_62_fu_473_p3 <= p_Val2_88_reg_111(7 downto 7);
    ...
    trunc_ln583_fu_262_p1 <= man_V_14_fu_200_p3(8 - 1 downto 0);
    ...
    z_i_V_fu_612_p3 <= 
        tmp_17_fu_602_p4 when (tmp_62_fu_473_p3(0) = '1') else 
        tmp_16_fu_592_p4;
    z_r_V_fu_584_p3 <= 
        tmp_15_fu_574_p4 when (tmp_62_fu_473_p3(0) = '1') else 
        tmp_s_fu_564_p4;
    zext_ln125_fu_434_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ush_reg_133),8));
    zext_ln126_fu_450_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ush_reg_133),64));
    ...
    zext_ln728_fu_469_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(a_V_fu_461_p3),8));
end behav;
