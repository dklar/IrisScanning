...
cordic360_Sin_fixed::cordic360_Sin_fixed(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    top_level_fptruncncg_U67 = new top_level_fptruncncg<1,2,64,32>("top_level_fptruncncg_U67");
    top_level_fptruncncg_U67->clk(ap_clk);
    top_level_fptruncncg_U67->reset(ap_rst);
    top_level_fptruncncg_U67->din0(reg_99);
    top_level_fptruncncg_U67->ce(ap_var_for_const0);
    top_level_fptruncncg_U67->dout(grp_fu_60_p1);
    top_level_fpext_3lbW_U68 = new top_level_fpext_3lbW<1,2,32,64>("top_level_fpext_3lbW_U68");
    top_level_fpext_3lbW_U68->clk(ap_clk);
    top_level_fpext_3lbW_U68->reset(ap_rst);
    top_level_fpext_3lbW_U68->din0(x);
    top_level_fpext_3lbW_U68->ce(ap_var_for_const0);
    top_level_fpext_3lbW_U68->dout(grp_fu_63_p1);
    top_level_dadd_64ocq_U69 = new top_level_dadd_64ocq<1,5,64,64,64>("top_level_dadd_64ocq_U69");
    top_level_dadd_64ocq_U69->clk(ap_clk);
    top_level_dadd_64ocq_U69->reset(ap_rst);
    top_level_dadd_64ocq_U69->din0(tmp_reg_162);
    top_level_dadd_64ocq_U69->din1(grp_fu_67_p1);
    top_level_dadd_64ocq_U69->ce(ap_var_for_const0);
    top_level_dadd_64ocq_U69->dout(grp_fu_67_p2);
    top_level_dcmp_64pcA_U70 = new top_level_dcmp_64pcA<1,2,64,64,1>("top_level_dcmp_64pcA_U70");
    top_level_dcmp_64pcA_U70->clk(ap_clk);
    top_level_dcmp_64pcA_U70->reset(ap_rst);
    top_level_dcmp_64pcA_U70->din0(tmp_reg_162);
    top_level_dcmp_64pcA_U70->din1(grp_fu_74_p1);
    top_level_dcmp_64pcA_U70->ce(ap_var_for_const0);
    top_level_dcmp_64pcA_U70->opcode(grp_fu_74_opcode);
    top_level_dcmp_64pcA_U70->dout(grp_fu_74_p2);
    top_level_dcmp_64pcA_U71 = new top_level_dcmp_64pcA<1,2,64,64,1>("top_level_dcmp_64pcA_U71");
    top_level_dcmp_64pcA_U71->clk(ap_clk);
    top_level_dcmp_64pcA_U71->reset(ap_rst);
    top_level_dcmp_64pcA_U71->din0(tmp_reg_162);
    top_level_dcmp_64pcA_U71->din1(ap_var_for_const1);
    top_level_dcmp_64pcA_U71->ce(ap_var_for_const0);
    top_level_dcmp_64pcA_U71->opcode(ap_var_for_const2);
    top_level_dcmp_64pcA_U71->dout(grp_fu_82_p2);
...
cordic360_Sin_fixed::~cordic360_Sin_fixed() {
    ...
    delete top_level_fptruncncg_U67;
    delete top_level_fpext_3lbW_U68;
    delete top_level_dadd_64ocq_U69;
    delete top_level_dcmp_64pcA_U70;
    delete top_level_dcmp_64pcA_U71;
}
