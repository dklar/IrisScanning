...
#ifndef _method1_imageIn_H_
#define _method1_imageIn_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "method1_imageIn_memcore.h"

SC_MODULE(method1_imageIn) {
...
protected:
    ...
    method1_imageIn_memcore* method1_imageIn_memcore_U;
...
public:
    ~method1_imageIn();
    SC_CTOR(method1_imageIn) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        method1_imageIn_memcore_U = new method1_imageIn_memcore("method1_imageIn_memcore_U");
        method1_imageIn_memcore_U->clk      ( clk );
        method1_imageIn_memcore_U->reset    ( reset );
        method1_imageIn_memcore_U->ce0      ( i_ce0 );
        method1_imageIn_memcore_U->we0      ( i_we0 );
        method1_imageIn_memcore_U->address0 ( memcore_iaddr );
        method1_imageIn_memcore_U->d0       ( i_d0 );
        method1_imageIn_memcore_U->q0       ( i_q0 );

        method1_imageIn_memcore_U->ce1      ( t_ce0 );
        method1_imageIn_memcore_U->we1      ( t_we0 );
        method1_imageIn_memcore_U->address1 ( memcore_taddr );
        method1_imageIn_memcore_U->d1       ( t_d0 );
        method1_imageIn_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "method1_imageIn.trace");
            // ports
