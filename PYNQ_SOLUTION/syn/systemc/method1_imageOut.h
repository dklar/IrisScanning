...
#ifndef _method1_imageOut_H_
#define _method1_imageOut_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "method1_imageOut_memcore.h"

SC_MODULE(method1_imageOut) {
    static const unsigned int DataWidth    = 8;
    static const unsigned int AddressRange = 32;
    static const unsigned int AddressWidth = 15;
...
protected:
    ...
    method1_imageOut_memcore* method1_imageOut_memcore_U;
...
public:
    ~method1_imageOut();
    SC_CTOR(method1_imageOut) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        method1_imageOut_memcore_U = new method1_imageOut_memcore("method1_imageOut_memcore_U");
        method1_imageOut_memcore_U->clk      ( clk );
        method1_imageOut_memcore_U->reset    ( reset );
        method1_imageOut_memcore_U->ce0      ( i_ce0 );
        method1_imageOut_memcore_U->we0      ( i_we0 );
        method1_imageOut_memcore_U->address0 ( memcore_iaddr );
        method1_imageOut_memcore_U->d0       ( i_d0 );
        method1_imageOut_memcore_U->q0       ( i_q0 );

        method1_imageOut_memcore_U->ce1      ( t_ce0 );
        method1_imageOut_memcore_U->we1      ( t_we0 );
        method1_imageOut_memcore_U->address1 ( memcore_taddr );
        method1_imageOut_memcore_U->d1       ( t_d0 );
        method1_imageOut_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "method1_imageOut.trace");
            // ports
