...
// ==============================================================
#ifndef __top_level_dcmp_64pcA__HH__
#define __top_level_dcmp_64pcA__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_dcmp_64pcA) {
    ...
    SC_CTOR(top_level_dcmp_64pcA):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
