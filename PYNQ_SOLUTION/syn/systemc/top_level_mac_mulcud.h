...
// ==============================================================
#ifndef __top_level_mac_mulcud__HH__
#define __top_level_mac_mulcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_mac_mulcud) {
    ...
    SC_CTOR(top_level_mac_mulcud):  simcore_mac_0_U ("simcore_mac_0_U") {
