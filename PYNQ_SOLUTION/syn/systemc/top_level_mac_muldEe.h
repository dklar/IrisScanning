...
// ==============================================================
#ifndef __top_level_mac_muldEe__HH__
#define __top_level_mac_muldEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_mac_muldEe) {
    ...
    SC_CTOR(top_level_mac_muldEe):  simcore_mac_1_U ("simcore_mac_1_U") {
