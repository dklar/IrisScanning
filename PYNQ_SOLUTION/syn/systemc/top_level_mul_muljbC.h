...
// ==============================================================
#ifndef __top_level_mul_muljbC__HH__
#define __top_level_mul_muljbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_mul_muljbC) {
    ...
    SC_CTOR(top_level_mul_muljbC):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
