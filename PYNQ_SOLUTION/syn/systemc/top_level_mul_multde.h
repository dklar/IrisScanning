...
// ==============================================================
#ifndef __top_level_mul_multde__HH__
#define __top_level_mul_multde__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_mul_multde) {
    ...
    SC_CTOR(top_level_mul_multde):  ACMP_smul_us_U ("ACMP_smul_us_U") {
