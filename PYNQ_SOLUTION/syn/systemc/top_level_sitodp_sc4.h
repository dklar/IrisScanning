...
// ==============================================================
#ifndef __top_level_sitodp_sc4__HH__
#define __top_level_sitodp_sc4__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_sitodp_sc4) {
    ...
    SC_CTOR(top_level_sitodp_sc4):  ACMP_sitodp_U ("ACMP_sitodp_U") {
